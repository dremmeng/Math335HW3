...
\item
	...
	\item
		\begin{equation*}
		\begin{split}
		\sqrt{n}(\bar{X} - X) &\rightarrow N(0,\sigma^{2}(x)) \\
		\sqrt{100}(\bar{X} - X) &\rightarrow N(0,1) \\
		(\bar{X} - X) &\rightarrow N(0,\frac{1}{100}) \\
		\end{split}
		\end{equation*}		
	\item
		$\bar{X}$ = 1.00004195 \\
...
\item
	...
	\item
		...
		(\bar{X} - \lambda) &\rightarrow N(0,1) \\
		(\bar{X} - \lambda) &\rightarrow N(\frac{\sqrt{10}}{10},\frac{1}{100}) \\
		\end{split}
		\end{equation*}
	\item
		$\bar{X}$ = .369698 \\
